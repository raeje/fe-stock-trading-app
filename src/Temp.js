    ...
    <>
      <ul className="space-y-2 pb-2">
        ...
        <li>
          <a
            href="#"
            className="text-base text-white font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group"
          >
            <svg
              className="w-6 h-6 text-white group-hover:text-gray-900 transition duration-75"
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
  ...
  return (
    <>
      <div className="flex items-center">
        ...
        <a
          href="/"
          className="hidden sm:inline-flex ml-5 text-white bg-custom-highlight hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3"
        >
          <svg
  ...
  return (
    <>
      <div className="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-8">
        ...
        <div className="bg-custom-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
...
function App() {
  return (
    <div className="App h-screen w-screen flex items-center justify-center border-red-500 border-4">
      <div className="z-1 bg-teal-50 h-screen w-screen flex items-center justify-center px-16 overflow-hidden ">
        <div className="relative w-full max-w-lg">
          <div className="absolute -top-80 -left-[40rem] w-[42rem] h-[42rem] bg-teal-300 rounded-full mix-blend-multiply opacity-100 animate-blob"></div>

          <div className="absolute top-10 -right-[30rem] w-[32rem] h-[32rem] bg-indigo-300 rounded-full mix-blend-multiply filter blur-sm opacity-100 animate-blob animation-delay-2000"></div>

          <div className="absolute -top-40 w-[42rem] h-[42rem] bg-cyan-300 rounded-full mix-blend-multiply opacity-100 animate-blob animation-delay-4000"></div>

          <div className="absolute -top-80 -right-[20rem] w-[24rem] h-[24rem] bg-blue-300 rounded-full mix-blend-multiply filter blur-sm opacity-100 animate-blob animation delay-[2000ms]"></div>

          <div className="z-10 h-11/12 w-4/5 bg-white-600 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-70 border border-gray-100 ">
            sample content
          </div>
        </div>
      </div>
